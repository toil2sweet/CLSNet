A demo implementation of the split fASJIONMNIST-10/5 experiment described in the submission, entitled **Harnessing Neural Unit Dynamics for Effective and Scalable Class-Incremental Learning**.
